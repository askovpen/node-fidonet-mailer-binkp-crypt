...
crypt.prototype.init_keys=function(){
	...
	for(var i = 0; i < this.password.length; ++i) {
		this.update_keys(this.password.charCodeAt(i));
	}
};
...
crypt.prototype.decrypt_byte=function(b) {
	var temp= (this.keys[2] & 0xffff) | 2;
	var ret=(((temp * (temp ^ 1)) >>> 8) & 0xff);
	return (ret);
};
...
crypt.prototype.crc32=function (c,b) {
	return this.table[(c^b)&0xFF]^(c>>>8);
};
